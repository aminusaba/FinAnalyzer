...
.venv\Scripts\alpaca-mcp-server.exe serve --transport streamable-http --host 127.0.0.1 --port 8000 --allowed-hosts "finanalyzer-zeta.vercel.app,localhost,localhost:5173"
pause
